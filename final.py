import sys
sys.path.append('../')
from utils.utils_final import preproc, vis
from utils.utils_final import Predictor
...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            origin_img = pred.inference(color_image, depth_image, class_to_track, conf = .5)
