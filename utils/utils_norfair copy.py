...
class Predictor:
    ...
    def inference(self, img_path, depth_data, class_to_track, conf=0.1):
        init_sound()
        W_pos=''
        H_pos=''
        near =False
        ...
        if dets is not None:
            ...
            for i in range(len(final_boxes)):
                ...
                if str(self.class_names[cls_id]) == class_to_track :
                    ...
                    if dist <= 6000 and dist >= 3000 and getChannelBusy(2) == False:
                        playSfx("1", 2) 
                        if centerX <= (W/5*2):
                            W_pos = " left "
                    ...
                    elif dist < 3000 and dist >= 1000 and getChannelBusy(2) == False:
                        playSfx("2", 2)
                        if centerX <= (W/5*2):
                            W_pos = " left "
                            threat_volume[0] = volume
                    ...
                    #     setChannelVolume(2, 1, 1)
                    #     #playSfx("aldynyzda",2)
                    elif dist < 1500 or math.isnan(dist) :
                        playBGM("2")
